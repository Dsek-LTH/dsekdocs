...
% use this for a study-council meeting,
% \documentclass[srd]{dsekminutes}

% or use this for a CEQ meeting,
% \documentclass[ceq]{dsekminutes}
...
\endparagraphed % End the paragraphed part here so that the signatures can use
