...
\section{Sektionen}
\paragraph{Namn}                % Use the paragraphed style
...
\paragraph{Ändamål}
% If you want to refer to a section later, you can label it like this.
\label{ändamål}
...
% Here we refer to the paragraph we labeled earlier
