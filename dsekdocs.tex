...
The paragraphed part usually runs untill you start a new section, subsection
etc. or until the end of the document.  Should you need to end the paragraphed
section early, you can do so with \cs{endparagraphed}.  This can be useful if
you want the whole page width available for signatures at the end of some
